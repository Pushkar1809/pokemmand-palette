...
function App() {
  ...
  return (
		<main className="relative w-full min-h-screen flex flex-col justify-center items-center">
			...
			<button onClick={() => setIsOpen(true)} className="bg-gradient-to-b to-slate-900 from-slate-600 text-white px-3 py-2 rounded-lg">
				Filter Pokemons{" "}
				<kbd className="px-1 rounded bg-gradient-to-b from-slate-100 to-slate-300 border border-slate-400">
					Cmd
				</kbd>{" "}
				+{" "}
				<kbd className="px-1 rounded bg-gradient-to-b from-slate-100 to-slate-300 border border-slate-400">
